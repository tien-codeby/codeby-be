<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:600px" align="center">
    <tbody>
       <tr>
          <td style="padding:0;color:#000000;text-align:left;background-color:#fff;width:100%;">
             <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;">
                <tbody>
                   <tr>
                      <td height="100%" valign="top">
                         <div style="margin:0;padding:0;direction:1tr;">
                            <center>
                               <table style="font-size:16px;font-family:Arial,sans-serif;font-weight:300;line-height:18px;color:#707070;border-collapse:separate;border-spacing:0;max-width:600px;padding:0;width:100%;margin:0 auto">
                                  <tbody>
                                     <tr>
                                        <td>
                                           <div style="border:solid 1px #e5e5e5;padding:40px 40px">
                                              <table style="margin:0;padding:0;border-collapse:collapse;width:100%;font-size:16px;">
                                                 <tbody>
                                                    <tr>
                                                       <td>
